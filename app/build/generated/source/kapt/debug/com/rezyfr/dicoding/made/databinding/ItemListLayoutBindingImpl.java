...
public class ItemListLayoutBindingImpl extends ItemListLayoutBinding  {
    ...
    public ItemListLayoutBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private ItemListLayoutBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        java.lang.String movieFullPosterPath = null;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
                ...
                if (movie != null) {
                    // read movie.fullPosterPath
                    movieFullPosterPath = movie.getFullPosterPath();
                }
        }
        // batch finished
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.rezyfr.dicoding.core.utils.BindingUtilsKt.loadImageUrl(this.ivPoster, movieFullPosterPath);
        }
    }
